<template>
    ...
    <main class="container-fluid text-tableText mx-5 rounded shadow-2xl py-[1%] lg:min-h-[80vh] border-[1px] border-borderGray my-[2%] flex flex-col justify-center items-center">
      ...
      <h1 class="text-center text-tableText leading-[30px] text-[20px] md:text-[30px]">Add Room</h1>
  
      <form @submit.prevent="submitForm()" class="flex flex-col w-[90%] md:w-[70%] lg:w-[50%] items-center mx-auto">
